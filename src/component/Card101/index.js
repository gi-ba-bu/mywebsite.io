...
const Card101 = (prop) => {
    ...
    return (
        ...
        A mobile-first app that aims to reduce food waste by letting users share information about reduced food items. It allows to upload pictures, add product details, and it integrates Google maps to pinpoint items on a map. Made using Flask, PostgreSQL and React.  
        </p>
